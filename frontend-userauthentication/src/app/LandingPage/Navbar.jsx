...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 w-full p-4 flex items-center shadow-md z-50 bg-white">
      ...
      <div className="flex-1 flex items-center justify-center md:justify-start">
        <Link href="/">
          <span
            id="dupayLink"
            className="text-2xl font-medium cursor-pointer bg-clip-text text-transparent bg-gradient-to-r from-[#7f2ee3] to-[#4246f7]"
          >
            Dupay
          </span>
        </Link>
      ...
      <ul className="hidden md:flex list-none gap-4 md:gap-8 m-0 p-0 items-center">
        <li>
          <Link
            href="/"
            className="text-black text-base md:text-lg no-underline transition-colors duration-300 hover:text-gray-700"
          >
            Home
          </Link>
        </li>
        ...
        <li className="flex gap-2 md:gap-4">
          <button
            className="bg-gradient-to-r from-[#7f2ee3] to-[#4246f7] text-white border-none py-1 md:py-2 px-3 md:px-5 text-base md:text-lg cursor-pointer rounded-full transition-colors duration-300 hover:bg-blue-800"
            onClick={handleLogin}
          >
            Login
          </button>
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed top-0 left-0 w-full h-full bg-white shadow-md z-40 transition-transform ${
      ...
      >
        ...
        <ul className="flex flex-col items-center gap-6 mt-8">
          <li>
            <Link
              href="/"
              className="text-black text-lg no-underline transition-colors duration-300 hover:text-gray-700"
              onClick={toggleMenu}
            >
              Home
            </Link>
          ...
          <li className="flex flex-col gap-2 w-full">
            <button
              className="bg-blue-600 text-white border-none py-2 px-5 text-lg cursor-pointer rounded-full transition-colors duration-300 hover:bg-blue-800 w-full"
              onClick={handleLogin}
            >
              Login
            </button>
